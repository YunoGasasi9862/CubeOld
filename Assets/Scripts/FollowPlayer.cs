...
public class FollowPlayer : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (Vector2.Distance(transform.position, Player.transform.position) >=15f)  //OMG IT WORKED! I FUCKING DID IT!!!  (IT FOLLOWS THE PLAYER UNTIL THE DISTANCE IS > 20)
        {
        ...
        else
        {
            ...
            transform.rotation = Quaternion.AngleAxis(previousAngle, Vector3.up);
        }
