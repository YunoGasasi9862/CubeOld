...
public class MoveAroundSun : MonoBehaviour
{
   ...
   [SerializeField] bool XY;
    ...
    void XtoZ()
    {
        ...
        transform.position = new Vector3(transform.parent.position.x + 60 * Mathf.Sin(angle * sign1 * 3), transform.position.y, transform.parent.position.z + 60 * Mathf.Cos((sign1) * angle * 3)) ;;
